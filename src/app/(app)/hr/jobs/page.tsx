...
import { addJob, deleteJob, updateJob, type JobFormValues } from '../actions';
...
import { departmentKeys } from '@/app/(app)/employees/page';
...
export default function JobPostingsPage() {
  ...
  async function onSubmit(values: JobFormValues) {
    const result = jobToEdit
      ? await updateJob(jobToEdit.id, values)
      : await addJob(values);
